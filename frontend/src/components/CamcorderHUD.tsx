  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-4 z-50 flex items-center gap-2 pointer-events-none">
        ...
        <span className="font-mono text-xs text-cream tracking-widest">
      ...
      <div className="fixed top-4 right-4 z-50 text-right pointer-events-none">
        <div className="font-mono text-xs text-cream tracking-wider">
          <div>{date}  {ts}</div>
      ...
      <div className="fixed bottom-4 left-4 z-50 pointer-events-none">
        <div className="font-mono text-[10px] text-cream/70 tracking-widest">
          <div>SP ■ HI-FI</div>
          <div className="text-sky-film">T-120</div>
        </div>
      </div>

      {/* Bottom-right: zoom level */}
      <div className="fixed bottom-4 right-4 z-50 pointer-events-none">
        <div className="font-mono text-[10px] text-cream/70 tracking-widest text-right">
